...
DICOM_DIR = r"C:\Users\Andrew\Downloads\DICOM-CT-PD_FD\DICOM-CT-PD_FD"
...
import tifffile
tiff_path = os.path.join(OUT_DIR, "full_recon_volume_fd.tiff")
...
plt.tight_layout()
plot_path = os.path.join(OUT_DIR, "full_recon_comparison_fd.png")
