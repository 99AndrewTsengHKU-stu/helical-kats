"""
Reproduce test03.yaml: small/fast phantom (54x56x58), SOD=50, SDD=80.
...
# --- Generate phantom ---
print(f"[test03] Generating phantom {ps['rows']}x{ps['columns']}x{ps['slices']} ...")
...
# --- Forward projection ---
print("[test03] Forward projection with ASTRA ...", end=" ", flush=True)
t0 = time()
...
# --- Katsevich filtering ---
print("[test03] Katsevich filtering ...")
...
print("[test03] Backprojection (Katsevich weighted) ...")
t0 = time()
...
fig.suptitle("test03: Phantom vs Katsevich Reconstruction")
...
plt.tight_layout()
out_path = os.path.join(OUT_DIR, "test03_result.png")
plt.savefig(out_path, dpi=150)
print(f"[test03] Saved -> {out_path}")
plt.close()
